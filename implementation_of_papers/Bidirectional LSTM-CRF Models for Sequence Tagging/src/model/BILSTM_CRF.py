...
class BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim, word_dim, device):
        """bidirectional long short term memory with conditional random field

        Args:
            vocab_size (int): input dimension
            tag_to_ix (dict): a dict that map tag to index
            embedding_dim (int): dimension of output word embedding
            hidden_dim (int): hidden dimension of LSTM
            word_dim (int): dimension of the word after padding
        """
        ...
        ## can replace this with arbitary pretrained word embedding
    ...
    def _forward_alg(self, feats):
        ...
        init_alphas = init_alphas.to(self.device)
    ...
    def forward(self, sentence):  # dont confuse this with _forward_alg above.
        ...
        # lstm_feats = lstm_feats.to(torch.device("cpu"))
